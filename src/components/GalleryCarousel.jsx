    ...
    <div className="container mx-auto p-6">
      ...
      <Slider {...settings}>
        {galleryImages.map((item, index) => (
          <div key={index} className="relative flex flex-col md:flex-row items-center md:items-start gap-6 p-6" style="display: flex;">
            ...
            {/* Content Section */}
            <div className="w-full md:w-1/2 flex flex-col justify-center bg-white/95 backdrop-blur-lg p-8 rounded-xl shadow-lg md:items-start md:text-left">
