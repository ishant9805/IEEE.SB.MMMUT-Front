...
const MembersCard = ({ members }) => {
    ...
    return (
        <div className="slider-container py-10 px-4">
            ...
            <Slider {...settings}>
                {members.map(member => (
                    <div key={member._id} className='mx-[40px]'>
                        <div className="bg-transparent rounded-lg  overflow-hidden hover:shadow-xl hover:scale-110 transition-all duration-300 max-w-[320px]  h-full mx-auto">
                            ...
                            <div className="p-4 text-center">
                                ...
                                <p className="text-lg font-bold  text-ieee-blue ">{member.post} ({member.committeeType === "sophomore" ? "2nd Year" : "Junior"})</p>
                                <p className="text-sm font-bold text-gray-500">{member.designation}</p>
                                <div className="mt-3 flex space-x-4 justify-center">
                                    ...
                                    <a href={member.ieeeProfile} target="_blank" rel="noopener noreferrer" className="text-ieee-blue hover:text-ieee-red transition-colors rounded-full border-2 p-1.5 border-ieee-blue hover:border-ieee-red">
